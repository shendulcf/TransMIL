...
def get_args():
    ...
    parser.add_argument('-s', '--slide', default=r'C:\Users\15284\Desktop\TransMIL-main\dataset\tcga',
                        help='Path to whole-slide image (SVS or JPG format) or folder of images (SVS or JPG) to analyze.')
    parser.add_argument('-o', '--out', default=r'data\Patches',
    ...
    parser.add_argument('--ov', type=float, default=0.5,
